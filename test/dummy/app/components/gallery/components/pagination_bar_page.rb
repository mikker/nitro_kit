    ...
    class PaginationBarPage < ComponentPage
      ...
      def component_template
        ...
        example_section(
          ...
          description: "Long summaries, omitted ranges, and preserved filter parameters stay outside the component's responsibilities."
        ) do
        ...
        example_section(
          ...
          description: "Table data, captions, counts, and links remain caller-owned around the placement component."
        ) do

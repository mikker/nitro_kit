  ...
  module Flows
    class ChangelogPage < ScenarioPage
      ...
      def release_title(release)
        ...
        "Typed application blocks for International Research, Production, Reliability Engineering, and Customer Operations"
      end
      ...
      def state_description
        {
          ...
          "mobile" => "Caller-owned compact release columns complement the narrow flow surface."
        }.fetch(state)
      end
    end
  end

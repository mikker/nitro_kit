    ...
    class LandingPage < ScenarioPage
      ...
      def render_announcement
        render NitroKit::Alert.new(variant: :success, id: "gallery-landing-announcement") do |alert|
          ...
          alert.description("The agent-native release adds typed layouts, application blocks, and static themeable CSS.")
        end
      end
      ...
      def features_path
        gallery_flow_path(slug: "features", state: "overview")
      end

      def flow_label = "Public landing flow"

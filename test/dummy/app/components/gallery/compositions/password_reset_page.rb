    ...
    class PasswordResetPage < Page
      ...
      def page_template
        ...
        render Section.new(
          ...
          description: "AuthShell constrains request, delivery, replacement, expiration, and submission states while the composition keeps its deterministic Turbo route."
        ) do
          render_example(
